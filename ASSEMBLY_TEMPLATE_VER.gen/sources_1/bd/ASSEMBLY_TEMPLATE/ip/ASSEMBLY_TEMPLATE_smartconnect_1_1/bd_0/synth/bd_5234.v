...
//--------------------------------------------------------------------------------
//Command: generate_target bd_5234.bd
//Design : bd_5234
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_5234,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_5234,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "ASSEMBLY_TEMPLATE_smartconnect_1_1.hwdef" *) 
module bd_5234
   (M00_AXI_awaddr,
    M00_AXI_awburst,
    M00_AXI_awcache,
  ...
  m00_exit_pipeline_imp_1S1W8Y1 m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_SA8RBE s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_V5LE1C s00_nodes
...
module m00_exit_pipeline_imp_1S1W8Y1
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awburst,
...
module s00_entry_pipeline_imp_SA8RBE
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_5234_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_5234_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_5234_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
