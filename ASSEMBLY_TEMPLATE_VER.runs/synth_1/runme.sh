...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/ASSEMBLY_TEMPLATE_VER/ASSEMBLY_TEMPLATE_VER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASSEMBLY_TEMPLATE_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASSEMBLY_TEMPLATE_wrapper.tcl
