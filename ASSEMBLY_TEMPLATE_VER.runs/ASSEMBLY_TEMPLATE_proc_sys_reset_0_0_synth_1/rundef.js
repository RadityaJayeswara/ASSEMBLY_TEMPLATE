...
ISEStep( "vivado",
         "-log ASSEMBLY_TEMPLATE_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASSEMBLY_TEMPLATE_proc_sys_reset_0_0.tcl" );
