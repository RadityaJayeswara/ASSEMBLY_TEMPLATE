...
HD_PWD='C:/Users/hp/Folder_Tugas_VIVADO/ASSEMBLY_TEMPLATE_VER/ASSEMBLY_TEMPLATE_VER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASSEMBLY_TEMPLATE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ASSEMBLY_TEMPLATE_wrapper.tcl -notrace
